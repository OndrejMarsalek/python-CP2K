...
class Parser:
    ...
    def readInputLine(self):
        ...
        while 1:
            ...
            if not coreLines[-1] or coreLines[-1][-1] != '\\':
                break
...
class Keyword:
    ...
    def __str__(self):
        ...
        #TODO: should this print, return, or both?
...
def read_section(f):
    ...
    while 1:
        ...
        if not lines or not lines.isspace():
            break
    preSectionComments = []
    ...
    sect_name = l[0][1:]
    sect_args = l[1:]
    if sect_name.lower() == 'end':
        raise SyntaxError("found dangling &END in %s" % f.old_pos(line))
